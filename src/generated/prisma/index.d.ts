...
export namespace Prisma {
  ...
  */
  ...
  export type universityOmit<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs> = $Extensions.GetOmit<"name" | "domains" | "webPages" | "country" | "alphaTwoCode" | "stateProvince" | "favorite" | "id", ExtArgs["result"]["university"]>
  ...
  export interface universityDelegate<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs, GlobalOmitOptions = {}> {
     ...
     * const universityWithNameOnly = await prisma.university.findMany({ select: { name: true } })
     * 
     */
     ...
     * })
     * 
     * // Create many Universities and only return the `name`
     * const universityWithNameOnly = await prisma.university.createManyAndReturn({
     *   select: { name: true },
     *   data: [
     *     // ... provide data here
     *   ]
     ...
     * })
     * 
     * // Update zero or more Universities and only return the `name`
     * const universityWithNameOnly = await prisma.university.updateManyAndReturn({
     *   select: { name: true },
     *   where: {
     *     // ... provide filter here
     *   },
  ...
  interface universityFieldRefs {
    ...
    readonly favorite: FieldRef<"university", 'Boolean'>
  ...
  export type universityWhereInput = {
    ...
    alphaTwoCode?: StringNullableFilter<"university"> | string | null
    stateProvince?: StringNullableFilter<"university"> | string | null
    favorite?: BoolFilter<"university"> | boolean
  ...
  export type universityOrderByWithRelationInput = {
    ...
    alphaTwoCode?: SortOrderInput | SortOrder
  ...
  export type universityScalarWhereWithAggregatesInput = {
    ...
    alphaTwoCode?: StringNullableWithAggregatesFilter<"university"> | string | null
    stateProvince?: StringNullableWithAggregatesFilter<"university"> | string | null
    favorite?: BoolWithAggregatesFilter<"university"> | boolean
  ...
  export type universityUpdateInput = {
    ...
    alphaTwoCode?: NullableStringFieldUpdateOperationsInput | string | null
